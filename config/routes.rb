ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :jobs
  map.resources :page_nodes,   :as => "page", :only => [:show], :member => {:show => [:get, :post], :request_a_review => :post, :document_audit_request => :post, :print_audit_request => :post, :thank_you => :post}
  ...
  map.connect 'demons',                                :controller => 'web', :action => 'demon_printers'
  ...
  # SEO
    ...
    map.connect 'mds_the_document_experts',            :controller => 'web', :action => 'mds_the_document_experts'
    map.connect 'mds_the_document_experts_thank_you', :controller => 'web', :action => 'mds_the_document_experts_thank_you'
